...
class FuncTargetType(IntEnum):
    ...
    NO_TARGET = 33
    FIELD_RANDOM = 34
    PLAYER_ATTACK_PRESELECT_TARGET_PT_ONE = 35
...
class NiceFuncTargetType(StrEnum):
    ...
    playerAttackPreselectTargetPtOne = "playerAttackPreselectTargetPtOne"
...
FUNC_TARGETTYPE_NAME: dict[int, NiceFuncTargetType] = {
    ...
    35: NiceFuncTargetType.playerAttackPreselectTargetPtOne,
}
...
class DataValsType(IntEnum):
    ...
    IsStun2WaitMode = 92
    ForceSubState = 93
    IgnoreIndivUnreleaseable = 94
    OnParty = 95
    CounterId = 96
    CounterLv = 97
    CounterOc = 98
    UseTreasureDevice = 99
    SkillReaction = 100
    BehaveAsFamilyBuff = 101
    UnSubStateWhileLinkedToOthers = 102
    NotAccompanyWhenLinkedTargetMoveState = 103
    NotTargetSkillIdArray = 104
    ShortTurn = 105
    FieldIndividuality = 106
    BGId = 107
    BGType = 108
    BgmId = 109
    TakeOverFieldState = 110
    TakeOverNextWaveBGAndBGM = 111
    RemoveFieldBuffActorDeath = 112
    FieldBuffGrantType = 113
    Priority = 114
    AddIndividualityEx = 115
    IgnoreResistance = 116
    GainNpTargetPassiveIndividuality = 117
    HpReduceToRegainIndiv = 118
    DisplayActualRecoveryHpFlag = 119
    ShiftDeckIndex = 120
    PopValueText = 121
    IsLossHpPerNow = 122
    CopyTargetFunctionType = 123
    CopyFunctionTargetPTOnly = 124
    IgnoreValueUp = 125
    ApplyValueUp = 126
    ActNoDamageBuff = 127
    ActSelectIndex = 128
    CopyTargetBuffType = 129
    NotSkillCopyTargetFuncIds = 130
    NotSkillCopyTargetIndividualities = 131
    ClassIconAuraEffectId = 132
    ActMasterGenderType = 133
    IntervalTurn = 134
    IntervalCount = 135
    TriggeredFieldCountTarget = 136
    TriggeredFieldCountRange = 137
    TargetEnemyRange = 138
    TriggeredFuncPositionSameTarget = 139
    TriggeredFuncPositionAll = 140
    TriggeredTargetHpRange = 141
    TriggeredTargetHpRateRange = 142
    ExcludeUnSubStateIndiv = 143
    ProgressTurnOnBoard = 144
    CheckTargetResurrectable = 145
    CancelTransform = 146
    UnSubStateWhenContinue = 147
    CheckTargetHaveDefeatPoint = 148
    NPFixedDamageValue = 149
    IgnoreShiftSafeDamage = 150
    ActAttackFunction = 151
    DelayRemoveBuffExpiredOnPlayerTurn = 152
    AllowRemoveBuff = 153
    NotExecFunctionIfKeepAliveOnWarBoard = 154
    SnapShotParamAddSelfIndv = 155
    SnapShotParamAddOpIndv = 156
    SnapShotParamAddFieldIndv = 157
    SnapShotParamAddValue = 158
    SnapShotParamAddMaxValue = 159
    SnapShotParamAddMaxCount = 160
    NotExecOnTransform = 161
    NotRemoveOnTransform = 162
    PriorityBgm = 163
    BgmAllowSubPlaying = 164
    BgPriority = 165
    PriorityBg = 166
    ResetPriorityBgmAtWaveStart = 167
    ControlOtherBgmAtOverStageBgm_Priority = 168
    ControlOtherBgmAtOverStageBgm_Target = 169
    ExtendBuffHalfTurnInOpponentTurn = 170
    ShortenBuffHalfTurnInOpponentTurn = 171
    ExtendBuffHalfTurnInPartyTurn = 172
    ShortenBuffHalfTurnInPartyTurn = 173
    LinkageBuffGrantSuccessEvenIfOtherFailed = 174
    DisplayNoEffectCauses = 175
    BattlePointId = 176
    BattlePointValue = 177
    BattlePointUiUpdateType = 178
    BattlePointOverwrite = 179
    CheckOverChargeStageRange = 180
    CheckBattlePointPhaseRange = 181
    StartingPosition = 182
    FriendShipAbove = 183
    DamageRateBattlePointPhase = 184
    ParamAddBattlePointPhaseId = 185
    ParamAddBattlePointPhaseValue = 186
    ShortenMaxCountEachSkill = 187
    ChargeHpMaxBeforeBreakGaugeUp = 188
    TargetFunctionIndividuality = 189
    TargetBuffIndividuality = 190
    TargetEnemyClass = 191
    ParamAddIndividualityTargetType = 192
    TriggeredFuncIndexAndCheckList = 193
    FuncCheckTargetIndividualityTargetType = 194
    FuncCheckTargetIndividualityCountHigher = 195
    FuncCheckTargetIndividualityCountLower = 196
    FuncCheckTargetIndividualityCountEqual = 197
    ParamAddSelfIndividualityAndCheck = 198
    ParamAddOpIndividualityAndCheck = 199
    ParamAddFieldIndividualityAndCheck = 200
    SnapShotParamAddSelfIndividualityAndCheck = 201
    SnapShotParamAddOpIndividualityAndCheck = 202
    SnapShotParamAddFieldIndividualityAndCheck = 203
    EnemyCountChangeTime = 204
    EnemyCountChangeEffectId = 205
    EnemyCountWaitTimeAfterMessage = 206
    WaitMessageEnd = 207
    ContinueDisplayMessage = 208
    MessageStartDelayTime = 209
    StartIntervalTurn = 210
    StartIntervalCount = 211
    CommonReleaseId = 212
    ForceTurnProgressIfTimingIsOverInPartyTurn = 213
    ForceTurnProgressIfTimingIsOverInOpponentTurn = 214
    OverwriteFuncInvalidType = 215
    BgmFadeTime = 216
    KeepChangeModelAfterContinue = 217
    DefenceDamageHigher = 218
    SameIndivBuffActorOnField = 219
    SyncUsedSameIndivBuffActorOnField = 220
    OnlyMaxFuncGroupId = 221
    UseAttack = 222
    CondParamAddType = 223
    CondParamAddValue = 224
    CondParamAddMaxValue = 225
    CondParamAddTargetId = 226
    CondParamRangeType = 227
    CondParamRangeMaxCount = 228
    CondParamRangeMaxValue = 229
    CondParamRangeTargetId = 230
    ExecOnce = 231
...
WAR_OVERWRITE_TYPE_NAME: dict[int, NiceWarOverwriteType] = {
    ...
    27: NiceWarOverwriteType.materialPriority,
