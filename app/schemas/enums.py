...
FUNC_VALS_NOT_BUFF = {
    ...
    FuncType.ADD_BATTLE_VALUE,
    FuncType.SET_BATTLE_VALUE,
    FuncType.ADD_BATTLE_MISSION_VALUE,
    FuncType.SET_BATTLE_MISSION_VALUE,
    FuncType.SET_BATTLE_MISSION_VALUE_AS_MAX,
}
