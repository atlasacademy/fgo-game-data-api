...
def get_quest_enemy(
    ...
    if user_svt.npcSvtClassId != 0:
        ...
        basic_svt.className = get_class_name(user_svt.npcSvtClassId)
    if (
...
async def get_quest_enemies(
    ...
    for stage, enemy_deck in enumerate(quest_detail.enemyDeck):
        ...
        enemy_decks = [
            ...
            if include_spawn_bonus_enemy or not is_spawn_bonus_enemy(deck)
        ]
        ...
        enemy_decks += [
            ...
            if (include_spawn_bonus_enemy or not is_spawn_bonus_enemy(deck))
            and deck.uniqueId in enemy_uniqueIds
        ]
