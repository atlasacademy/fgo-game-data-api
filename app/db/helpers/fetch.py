...
schema_map_fetch_one: dict[  # type:ignore
    ...
    MstEventDetail: (mstEventDetail, mstEventDetail.c.eventId),
...
schema_table_fetch_all: dict[  # type:ignore
    ...
    MstEventTradeGoods: (
        mstEventTradeGoods,
        mstEventTradeGoods.c.eventId,
        mstEventTradeGoods.c.id,
    ),
    MstEventTradePickup: (
        mstEventTradePickup,
        mstEventTradePickup.c.eventId,
        mstEventTradePickup.c.tradeGoodsId,
    ),
    MstEventQuest: (
        mstEventQuest,
...
schema_table_fetch_all_multiple: dict[  # type:ignore
    ...
    MstItemDropEfficiency: (
        mstItemDropEfficiency,
        mstItemDropEfficiency.c.itemId,
        [
            mstItemDropEfficiency.c.itemId,
