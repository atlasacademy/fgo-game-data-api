...
export enum NiceQuestGroupType {
    NONE = "none",
    EVENT_QUEST = "eventQuest",
    QUEST_RELEASE = "questRelease",
    EVENT_POINT_QUEST = "eventPointQuest",
    EVENT_POINT_GROUP_QUEST = "eventPointGroupQuest",
    EVENT_RACE_QUEST = "eventRaceQuest",
    EVENT_RACE_GROUP_QUEST = "eventRaceGroupQuest",
    MISSION_GROUP_QUEST = "missionGroupQuest",
    EVENT_TOWER = "eventTower",
    EVENT_TOWER_FLOOR = "eventTowerFloor",
    HIGHLIGHT_QUEST = "highlightQuest",
    EVENT_DAILY_POINT = "eventDailyPoint",
    EVENT_ACTIVITY_POINT_GAUGE = "eventActivityPointGauge",
    INTERLUDE = "interlude",
    EVENT_BATTLE_LINE = "eventBattleLine",
...
export enum NiceAiCondParameter {
    ...
    MASTER_COMMAND_SPELL_COUNT = "masterCommandSpellCount",
    CHECK_MASTER_SKILL_THISTURN = "checkMasterSkillThisturn",
...
export enum NiceEventMissionCondDetailType {
    ENEMY_KILL_NUM = "enemyKillNum",
    ENEMY_INDIVIDUALITY_KILL_NUM = "enemyIndividualityKillNum",
    ITEM_GET_TOTAL = "itemGetTotal",
    BATTLE_SVT_IN_DECK = "battleSvtInDeck",
    BATTLE_SVT_EQUIP_IN_DECK = "battleSvtEquipInDeck",
    TARGET_QUEST_ENEMY_KILL_NUM = "targetQuestEnemyKillNum",
    TARGET_QUEST_ENEMY_INDIVIDUALITY_KILL_NUM = "targetQuestEnemyIndividualityKillNum",
    TARGET_QUEST_ITEM_GET_TOTAL = "targetQuestItemGetTotal",
    QUEST_CLEAR = "questClear",
    QUEST_CLEAR_NUM = "questClearNum",
    SVT_GET_NUM = "svtGetNum",
    ALL_QUEST_ITEM_GET_TOTAL = "allQuestItemGetTotal",
    ALL_INDIVIDUALITY_IN_ENEMY_KILL_NUM = "allIndividualityInEnemyKillNum",
    TARGET_ENEMY_CLASS_KILL_NUM = "targetEnemyClassKillNum",
    TARGET_SVT_ENEMY_CLASS_KILL_NUM = "targetSvtEnemyClassKillNum",
    TARGET_ENEMY_INDIVIDUALITY_CLASS_KILL_NUM = "targetEnemyIndividualityClassKillNum",
    BATTLE_SVT_INDIVIDUALITY_SPECIFIC_NUM = "battleSvtIndividualitySpecificNum",
    BATTLE_SVT_CLASS_SPECIFIC_NUM = "battleSvtClassSpecificNum",
    ALL_QUEST_SVT_GET_TOTAL = "allQuestSvtGetTotal",
    QUEST_GROUP_CLEAR_NUM = "questGroupClearNum",
    GACHA_DRAW_NUM = "gachaDrawNum",
    QUEST_CLEAR_WITH_SVT_IN_DEC = "questClearWithSvtInDec",
    QUEST_CLEAR_WITH_SVT_IN_DECK_NONE_FOLLOWER = "questClearWithSvtInDeckNoneFollower",
    QUEST_PHASE_CLEAR_NUM = "questPhaseClearNum",
    EVENT_ITEM_USE_NUM = "eventItemUseNum",
    EVENT_BOARD_GAME_CELL_NUM = "eventBoardGameCellNum",
    FRIEND_AND_FOLLOW_NUM = "friendAndFollowNum",
    QUEST_PHASE_CLEAR_NUM_QUEST_TYPE = "questPhaseClearNumQuestType",
    QUEST_PHASE_CLEAR_NUM_QUEST_GROUP = "questPhaseClearNumQuestGroup",
    QUEST_PHASE_CLEAR_NUM_WAR_ID = "questPhaseClearNumWarId",
    QUEST_PHASE_CLEAR_NUM_WITH_WAR_BOARD = "questPhaseClearNumWithWarBoard",
    QUEST_CLEAR_WITH_SVT_IN_DECK_ONLY_STARTING_MEMBER = "questClearWithSvtInDeckOnlyStartingMember",
    QUEST_CLEAR_WITH_SVT_IN_DECK_NONE_FOLLOWER_ONLY_STARTING_MEMBER = "questClearWithSvtInDeckNoneFollowerOnlyStartingMember",
    BATTLE_EXCHANGE_SVT_IN_DECK = "battleExchangeSvtInDeck",
    USE_TREASURE_DEVICE_EXCHANGE_SVT = "useTreasureDeviceExchangeSvt",
    PLAY_VOICE_EXCHANGE_SVT = "playVoiceExchangeSvt",
...
export enum NiceBattleBranchSkillCondBranchType {
    None_ = "none",
...
export enum NiceQuestAfterActionCommand {
    ...
    SPOT_ANIM = "spotAnim",
    SPOT_HIDE_QUICK = "spotHideQuick",
    SPOT_GRAY_QUICK = "spotGrayQuick",
    SPOT_DISP_QUICK = "spotDispQuick",
    SPOT_CHANGE_QUICK = "spotChangeQuick",
    SPOT_ANIM_QUICK = "spotAnimQuick",
    ROAD_HIDE = "roadHide",
    ROAD_GRAY = "roadGray",
    ROAD_DISP = "roadDisp",
    ...
    CAM_MV_COORD = "camMvCoord",
    CAM_ZOOM = "camZoom",
    CAM_MV_ZOOM_SPOT = "camMvZoomSpot",
    CAM_MV_ZOOM_ROAD = "camMvZoomRoad",
    CAM_MV_ZOOM_GIMMICK = "camMvZoomGimmick",
    CAM_MV_ZOOM_COORD = "camMvZoomCoord",
    CAM_3D_MV_LAYER = "cam3DMvLayer",
    CAM_3D_MV_COORD = "cam3DMvCoord",
    CAM_3D_MV_ZOOM_COORD = "cam3DMvZoomCoord",
    GIMMICK_HIDE = "gimmickHide",
    GIMMICK_DISP = "gimmickDisp",
    GIMMICK_HIDE_QUICK = "gimmickHideQuick",
    GIMMICK_DISP_QUICK = "gimmickDispQuick",
    GIMMICK_MV_COORD = "gimmickMvCoord",
    GIMMICK_DISP_WITH_FADE = "gimmickDispWithFade",
    GIMMICK_TWEEN_COLOR = "gimmickTweenColor",
    GIMMICK_SET_COLOR = "gimmickSetColor",
    GIMMICK_DISP_UPDATE = "gimmickDispUpdate",
    GIMMICK_DISP_PILE_UP = "gimmickDispPileUp",
    GIMMICK_MV_SPOT = "gimmickMvSpot",
    GIMMICK_MV_GIMMICK = "gimmickMvGimmick",
    GIMMICK_MV_ROAD = "gimmickMvRoad",
    QUEST_FOCUS = "questFocus",
    QUEST_UNFOCUS = "questUnfocus",
    PLAYER_FOCUS = "playerFocus",
    AFTER_FADE_IN = "afterFadeIn",
    QUEST_START = "questStart",
    MAP_CHANGE = "mapChange",
    START_MAP_CHANGE = "startMapChange",
    TITLE_INFO_CONTROL = "titleInfoControl",
    MESSAGE_WINDOW = "messageWindow",
    MESSAGE_WINDOW_MST = "messageWindowMst",
    MESSAGE_OTHER_WINDOW = "messageOtherWindow",
    MESSAGE_OTHER_WINDOW_MST = "messageOtherWindowMst",
    MESSAGE_OTHER_WINDOW_BOOST_SUPPORT = "messageOtherWindowBoostSupport",
    EVENT_REWARD = "eventReward",
    WHITE_EARTH_TRANS = "whiteEarthTrans",
    TRANSITION_TO_FOLDER = "transitionToFolder",
    ...
    BGM_PLAY = "bgmPlay",
    WAIT = "wait",
    BLANK_EARTH_OBJECT_HIDE = "blankEarthObjectHide",
    BLANK_EARTH_OBJECT_DISP = "blankEarthObjectDisp",
    BLANK_EARTH_OBJECT_ANIM = "blankEarthObjectAnim",
    BLANK_EARTH_OBJECT_HIDE_QUICK = "blankEarthObjectHideQuick",
    BLANK_EARTH_OBJECT_DISP_QUICK = "blankEarthObjectDispQuick",
