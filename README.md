...
```
python .\scripts\update_ce_translation.py --mapping .\app\data\mappings\equip_names.json --jp-master ..\fgo-game-data-jp\master --na-master ..\fgo-game-data-na\master
```