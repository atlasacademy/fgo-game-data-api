...
```sh
git clone --depth 1 --branch JP https://git.atlasacademy.io/atlasacademy/fgo-game-data.git fgo-game-data-jp
git clone --depth 1 --branch NA https://git.atlasacademy.io/atlasacademy/fgo-game-data.git fgo-game-data-na

# It's not neccecary to clone the other regions.
git clone --depth 1 --branch CN https://git.atlasacademy.io/atlasacademy/fgo-game-data.git fgo-game-data-cn
git clone --depth 1 --branch KR https://git.atlasacademy.io/atlasacademy/fgo-game-data.git fgo-game-data-kr
git clone --depth 1 --branch TW https://git.atlasacademy.io/atlasacademy/fgo-game-data.git fgo-game-data-tw
